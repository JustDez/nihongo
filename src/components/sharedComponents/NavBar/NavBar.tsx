...
import { useState } from 'react'; //for my hooks
import {
    Button,
    Drawer, 
    ListItemButton,
...
const handleDrawerOpen = () => {
 ...
 //dictionary/object for NavLinks
const navLinks = [
    {
        text: 'Home',
        icon: <HomeIcon/>,
    ...
    {  
        text: myAuth === 'true' ? 'Translate' : 'Sign In',
        icon: myAuth === 'true' ? <TranslateIcon /> : <AssignmentIndIcon />,
        onClick: () => navigate(myAuth === 'true' ? '/translate' : '/auth') 
    },
    {  
        text: myAuth === 'true' ? 'Saved' : '',
        icon: myAuth === 'true' ? <SaveIcon /> : "",
